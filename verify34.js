...
(async () => {
  ...
  /* 16회차: R «ref 카드 298/296/297 · 거터 19/18 vs 우리 298/298/298 · 17/17» · S «거터 +2» 방향 일치.
     그리드 바깥(76..1003)은 R 이 «0 차이» 확인 → 총폭 고정, gap 17→18.5 ⇒ 카드 297 · x 76/391.5/707 */
  ok('J7 카드 x 76/391.5/707 · w297', geo.c1[0] === 76 && Math.abs(geo.c2[0] - 391.5) <= 1 && geo.c3[0] === 707
     && geo.c1[2] === 297, [geo.c1[0], geo.c2[0], geo.c3[0]].join('/'));
