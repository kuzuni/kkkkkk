...
(async () => {
  ...
  /* 326(2026-08-28) — 상한은 «단계×100» 이 아니라 «단계 몫 100×n 의 누적합» 이다.
     단계 2 = 100 + 200 = 300. 112 가 지키는 것은 «단계가 오르면 상한이 넓어진다» 이지 그 숫자가 아니다. */
  eq('⑥ 상한 재확장 (326 누적합 — 단계 2 = 100+200)', up.cap, 300);
