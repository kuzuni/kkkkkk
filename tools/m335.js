...
const REF = {
  ...
  /* 337 (2026-08-28) 이관 — ref 바 검정 하변은 2112~2117 이라 외곽 하변은 2118 이 아니라 **2117**,
     외곽 높이는 98 이 아니라 **97** 이다(2020/2118 은 JPEG AA 한 줄씩). 07 측정표 §9 정오표 참조. */
  barBottom: 2117 - 60,   /* 2057 */
  barH: 97,
  barX: 151, barW: 794, barRight: 944,
  barCx: 547.5,           /* 화면중심 539.5 대비 +8 (레퍼런스 비대칭) */
  tabbarTop: 2160 - 60,   /* 2100 */
  gapBarToTabbar: 43,    /* 337 — 2160 − 2117 = 43 (바 하변을 2117 로 바로잡은 몫) */
