...
def main():
    ...
    for y in range(H - 1, H // 2, -1):
        ...
        if n > (W - 40) * 0.9:
            gold = y
            break
    inner = gold - 2                       # 금테 밝은 줄 위의 어두운 금테 1행까지 제외
    ...
    print('  아래/위 = **%.2f**' % ratio)
    print()
    print('  대조 — 1회차 CF·CG 0.58~0.62(위 31~38 : 아래 18~23) · 5회차 CP 0.75(26.7:20.0) · CQ 0.82(24.4:20.0)')
    print('  ⚑ 이 자의 «아래» 20.0 은 CP·CQ 의 20.0 과 **소수점까지 같다** — 같은 두 지형지물을 쟀다는 증거다.')
