...
/* ⚑⚑ 980 — **예열(버리는 첫 장).** 이 페이지의 **첫 스크린샷은 우리가 부탁한 상태가 아니다**:
   ...
   ⚑⚑ **986 정오 — 위 «+740~770px 로 같다» 는 이 러너의 그날 판이다.** 늦게 그려지느냐는 판마다 다르고
     (실측 Δ **0 · 0 · 0 · 525 · 428 · 252px**), 늦은 판도 팝이 도는 중이라 배율이 1.0~1.05 사이 어디든이라
     748 언저리일 이유가 없다. **버리는 규약은 그대로 · 버린 몫의 «값» 에는 문턱을 걸지 마라** —
     `probe980` [6-a] 가 그 문턱 탓에 4판 중 3판 빨갰다(등재·수리 986).
