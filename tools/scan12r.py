...
INKS = [
    ('title',  WHITE, 400,  700,  735,  800, SM_TOP),   # «소환 결과»
    ...
    ('badge0', WHITE, 100,  132, 1030, 1076, SM_CARD),  # 개수 배지 r0c0
    ('badge1', WHITE, 100,  132, 1200, 1245, SM_CARD),  # 개수 배지 r1c0
]
...
def measure(cap_path):
    ...
    m['cap']['cardcols'] = [r[0] for r in hruns(cap, 940 - SM_CARD, BLACK, 0, 1080, 4)][:12]
    ...
    m['cap']['cardrows'] = [[a + SM_CARD, b + SM_CARD] for a, b in
                            vruns(cap, 78, BLACK, 880 - SM_CARD, 1250 - SM_CARD)]
