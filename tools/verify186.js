...
(async () => {
  ...
  /* [E] 해금 안내 — «언제 열리는지» 가 보여야 한다(지시서 등재문의 처방).
     소환 Lv 1 에서는 희귀(5)·영웅(15)·전설(30)·신화(40)·초월(55)·불멸(75) 6개 행이 잠겨 있고,
     Lv 100 에서는 한 칸도 없어야 한다 — «미보유»(자물쇠)와 «미해금»(등급 자체가 안 나옴)은 다르다. */
  ...
  /* [E4] 보유한 칸에는 안내가 붙지 않는다 — 이미 가진 물건에 «소환 Lv.75» 는 거짓말이다. */
