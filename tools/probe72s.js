/* 작업 72(2026-08-26 주인 재지시) — 던전 카드 6장에 넣을 «실제 스프라이트» 후보 잉크 bbox 실측.
   ...
   슬롯 종횡: **8장 전부 330×330(1.000)** — 259(2026-08-27 주인 보고)로 카드1·2 의
   311×305(1.020)·296×289(1.024) 를 폐기하고 relic 규격으로 통일했다. 종횡비가 한 값이므로
   후보 잉크의 «어느 카드에 앉히느냐» 로 담김(contain) 배율이 갈리지 않는다.
