...
const EXP = {
  ...
  bl:  { h: 690, ntcN: 2, sH: 114, pitch: 227, cen0: 160, hdb: 102, rb: 76, art: { w: 462, h: 281 } }
};
...
(async () => {
  ...
  /* ⚑ 885 1회차 이관 — **세로 두 값이 바뀌었다**(333 처방 — 자리를 안 비우고 값만 옮긴다).
     ...
     ⚠ **폭·좌단(462/500)은 안 옮겼다** — 두 비평가가 «어디까지가 티켓인가» 정의로 갈렸다(A3-ⓑ). */
  ok('F5 불릿형 일러스트 자리 = ref 환산 (500,**142**) 462×**281**  (세로는 885 1회차 3자 실측 · 폭·좌단은 §9 그대로)',
    fbls.every(c => near(c.art.l, 500, 1) && near(c.art.t, 142, 1) && near(c.art.w, 462, 1) && near(c.art.h, 281, 1)),
