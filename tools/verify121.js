...
/* ⚠ 2026-08-27(259, 저장소 주인 보고) — 던전 카드 1·2(황금 동굴·수정 광산)만 311/36 · 296/52 로
   나머지와 달라 «액자가 작고 위치도 어긋나» 보였다. 8장 전부 relic 규격 330/11 로 통일했다.
   레이드·아레나(RAID_TH)는 97 «꽉 채우기» 규칙이라 별개 — 그대로 둔다. */
const DUN_TH = Array.from({ length: 8 }, () => [330, 11]);
