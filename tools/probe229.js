 ...
 *
 * ⚑ 2026-08-29 — **이 물음의 답은 360 이 갈아치웠다.** 229 의 결론(«ref 좌표가 맞다»)은 그때는
 *   옳았고 제품도 Δ0 으로 따르고 있었지만, 작업 360(저장소 주인 지시)이 «출석» 단독 규격과
 *   ref 의 비균등 pitch 를 **의도적으로 이탈**시켜 지금 규격은 «1행 top 176 + 전 행 등간격 134» 다.
 *   ⇒ 아래 «Δref» 열이 −24~−28 로 찍히는 것은 **결함이 아니라 그 이탈의 크기**다.
 *   현행 규격을 재는 것은 `tools/verify71.js`(좌표·pitch)와 `tools/verify360.js`(잉크·구조)이고,
 *   수리 전/후 대조는 `tools/probe360.js` 가 갖고 있다.
 */
