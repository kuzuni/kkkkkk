 ...
 *   [C] 알약  — 바깥 **260×57.8** · 속 246.6×44.4 ↔ ref 260.0×57.8 / 246.7×44.4 · 중심 200 유지
...
const REF = {
  ...
  pillW: 260.0, pillH: 57.8,     // 검정 테두리 바깥 117×26 ref px
  pillIW: 246.7, pillIH: 44.4,   // 속(평평한 #191614 칠) 111×20 ref px
};
