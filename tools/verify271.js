...
(async () => {
  ...
  ok(geo.hd && geo.hd[1] === 34 && geo.hd[3] === 64,
    '★ 687 — 재화 잔량 헤더가 본문 머리(박스 local top 34) · 높이 64(2회차 — 비평 2인 «띠가 얇다»)',
    geo.hd && geo.hd[1] + ' / ' + geo.hd[3]);
  ok(geo.dn[1] === 120 && geo.dn[3] === 98,
    '하위 바가 헤더 아래(박스 local top 120 = 34+64+22) · 부품 높이 98', geo.dn[1] + ' / ' + geo.dn[3]);
