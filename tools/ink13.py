...
ITEMS = [
    ...
    ('카드① 보석',            (220, 904,  58, 31), WHITE),
    ('카드② 공물',            (512, 906,  56, 33), WHITE),
    ('카드③ 골드 상자',       (762, 906, 137, 32), WHITE),
    ('카드④ 상자 열쇠',       (126, 1228, 247, 28), WHITE),
    ('카드⑤ 강화석',          (419, 1225, 240, 33), WHITE),
    ('카드⑥ 소환 열쇠',       (707, 1227, 246, 30), WHITE),
    ('카드② ×50',             (572, 1052,  81, 30), WHITE),
    ('카드③ ×1',              (862, 1048,  38, 33), WHITE),
    ('카드⑤ ×30',             (572, 1371,  80, 31), WHITE),
