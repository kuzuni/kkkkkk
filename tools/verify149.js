...
const TOAST_SITES = [
  ...
  ['가방 칸 상세',               '보유 <b>\' + fmt(+c.dataset.bagq)'],
...
const WORST = [
  ...
  { n: '마일리지 교환',   f: 'D => D.icDia + " <b>999.99Z</b> 획득 · 남은 쿠폰 999개"' },
  { n: '유물조각 교환',   f: 'D => D.icDia + " <b>999.99Z</b> → " + D.icRel + " <b>999.99Z</b>"' },
