...
/* 3회차 — 들썩 주기를 5~7s 로 좁히면서(P F) 구간이 바뀌었다. 다시 풀어 **t=3600 · 13400(각 2장 동시)**.
   나머지는 짧은 주기(0.9s 링 · 2.6s 둥실 · 4s 스윕)와 20s 광선을 고루 훑는다. */
const STOPS = [0, 230, 450, 900, 1600, 2600, 3600, 5700, 8300, 13400];
