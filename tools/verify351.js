...
(async () => {
  ...
  try {
    ...
    eq('[9-i] 1600 21 도감 상자 높이 = 프레임 − 481', c13.cl.h, 1600 - 481, 1);
    ...
    (c13.clRib && c13.clRib.top === c13.pedge.bot)
      ? ok('[9-k] 1600 21 도감 리본 상변이 HUD 잉크 끝에 정확히 선다', `${c13.clRib.top} = ${c13.pedge.bot}`)
      : no('[9-k] 1600 21 도감 리본 상변이 HUD 잉크 끝에 정확히 선다', `${c13.clRib ? c13.clRib.top : '?'} vs ${c13.pedge.bot}`);
