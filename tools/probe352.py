...
print('   cap  x 65~1014 (w 950) · y 1961~2057 (h 97)')

print('\n ⓑ 셸 검정 테두리 — «ref 8 ↔ 우리 6» 인가')
border('ref', ref7, 66, 1013, 2021, 2117, 2069, 663)
border('cap', cap7, 65, 1014, 1961, 2057, 2009, 663)
...
print('   ⇒ 세로는 자를 안 대도 확정이다 — 셸 97 · 알약 85 가 둘 다 ref 와 Δ0(337) 이므로 97−85 = 2×6.')
